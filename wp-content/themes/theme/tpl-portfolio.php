			...
			while( have_posts() ):
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>><?php 
					...
					wp_link_pages( array(	
						...
						'pagelink' =>	'%',
						'echo'	=>	1 ) );
					edit_post_link( esc_html__( ' Edit ','finance' ) );?>
        ...
        <?php $post_layout = isset( $tpl_default_settings['portfolio-post-layout'] ) ? $tpl_default_settings['portfolio-post-layout'] : "one-half-column";
			...
			if( (sizeof($categories) > 1) && (array_key_exists("filter",$tpl_default_settings)) ) :
                ...
                <div class="dt-sc-portfolio-sorting <?php echo esc_attr($post_style);?>">
                	<a href="#" class="active-sort" title="" data-filter=".all-sort"><?php esc_html_e('All','finance');?></a>
                                ...
                                <div class="image-overlay">
                                    ...
                                    <?php elseif( $post_style == "type1" || $post_style == "type2" || $post_style == "type5" || $post_style == "type7" || $post_style == "type8"):?>
                                            ...
                                            <div class="image-overlay-details">
												<h2><a href="<?php the_permalink();?>" title="<?php printf( esc_attr__('Permalink to %s','finance'), the_title_attribute('echo=0'));?>"><?php 
													the_title();?></a></h2><?php
												if( $post_style != "type2"):
													if( $post_style == "type7" ):
            ...
            <div class="pagination blog-pagination">
            	<?php echo finance_pagination($the_query); ?>
            </div><!-- **Pagination** --> 
        <!-- Portfolio Template -->        

...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
                        ...
                        <?php if( $format == "image" || empty($format) ) :
                                if( has_post_thumbnail() ) :?>
                                    <div class="entry-thumb">
                                        <a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s','finance'),the_title_attribute('echo=0'));?>"><?php the_post_thumbnail("full");?></a>
                                ...
                                <div class="entry-details">
                                    ...
                                    <div class="entry-date <?php echo esc_attr($tclass);?>">
                                        ...
                                        <div class="<?php echo esc_attr($show_comment_meta);?>"><?php
                                            comments_popup_link( 
												wp_kses( __('<i class="pe-icon pe-chat"> </i> 0','finance') , array( 'i' => array('class' => array(), 'id' => array()) ) ),
												wp_kses( __('<i class="pe-icon pe-chat"> </i> 1','finance') , array( 'i' => array('class' => array(), 'id' => array()) ) ),
                                                wp_kses( __('<i class="pe-icon pe-chat"> </i> %','finance') , array( 'i' => array('class' => array(), 'id' => array()) ) ), 
                                                '',
                                                wp_kses( __('<i class="pe-icon pe-chat"> </i>','finance') , array( 'i' => array('class' => array(), 'id' => array())) ) );?>
                                        </div><!-- comment -->                                         
                                     </div><!-- .entry-date -->
                                	...
                                	<div class="entry-title">
                                    	<h4><a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s','finance'), the_title_attribute('echo=0'));?>"><?php the_title(); ?></a></h4>
                                    </div>
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo finance_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                   <?php endif;?>
                                   ...
                                   <div class="entry-meta-data <?php echo esc_attr($tclass);?>">
                                   		...
                                   		<p class="author <?php echo esc_attr( $show_author_meta );?>">
                                            ...
                                            <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" 
                                            	title="<?php esc_attr_e('View all posts by ', 'finance'); echo get_the_author();?>"><?php echo get_the_author();?></a>
                                        </p>
                        ...
                        <?php elseif( $post_style == "entry-date-author-left"):
                        		...
                        		<div class="entry-date-author <?php echo esc_attr($tclass);?>">
                                    ...
                                    <div class="entry-author <?php echo esc_attr( $show_author_meta );?>">
                                    	...
                                    	<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" 
                                        	title="<?php esc_attr_e('View all posts by ', 'finance'); echo get_the_author();?>"><span><?php echo get_the_author();?></span></a>
                                    </div>
                        		...
                        		<div class="entry-details">
                                    ...
                                    <div class="entry-meta <?php echo esc_attr($tclass);?>">
                                    	...
                                    	<div class="date <?php echo esc_attr($show_date_meta);?>"><?php
                                        	if( $post_style == "bordered"):
												echo '<span>'.get_the_date('d').'</span>'.get_the_date('M');
											else:
												esc_html_e('Posted on','finance'); echo get_the_date(' d M Y');
											endif;?>
                                        </div>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo finance_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
